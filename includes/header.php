...
<div class="header">
	<div class="container">
		<div class="logo wow fadeInDown animated" data-wow-delay=".5s">
			<a href="index.php">EXMATE Tourism <span class="text">Management System</span></a>	
		</div>
					...
					<nav class="cl-effect-1">
						<ul class="nav navbar-nav">
							...
							<li><a href="page.php?type=aboutus">About</a></li>
								...
								<li><a href="hotel-list.php">Hotel Booking</a></li>
								<li><a href="https://seatreservation.railway.gov.lk/mtktwebslr/">Train Booking</a></li>
