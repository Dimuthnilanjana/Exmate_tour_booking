...
<html>
<head>
<title>EXMATE | Admin Change Password</title>
  ...
  <div class="panel-body">
					<form  name="chngpwd" method="post" class="form-horizontal" onSubmit="return valid();">
						...
						<div class="form-group">
							<label class="col-md-2 control-label text-center">Current Password</label>
							<div class="col-md-8">
	...
	<div class="form-group">
							<label class="col-md-2 control-label text-center">New Password</label>
							<div class="col-md-8">
								<div class="input-group">
									<span class="input-group-addon">
										<i class="fa fa-key"></i>
	...
	<div class="form-group">
							<label class="col-md-2 control-label text-center">Confirm Password</label>
							<div class="col-md-8">
								<div class="input-group">
									<span class="input-group-addon">
										<i class="fa fa-key"></i>
