...
<html>
<head>
<title>EXMATE | Admin Package Update</title>
...
<!---->
  <div class="grid-form1">
  	       <h3 class="text-center"><strong>Update Package</strong></h3>
...
<div class="col-sm-8">
<img src="pacakgeimages/<?php echo htmlentities($result->PackageImage);?>" width="200">&nbsp;&nbsp;&nbsp;<a href="change-image.php?imgid=<?php echo htmlentities($result->PackageId);?>" class="text-decoration-none">Change Image</a>
</div>
</div>
