...
<html>
<head>
<title>EXMATE | Admin Manage Bookings</title>
...
<div class="agile-grids">	
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2 class="text-center"><strong>Manage Bookings</strong></h2>
					    <table id="table">
						<thead>
						  <tr>
						  <th>Booikn id</th>
...
{				?>		
						  <tr>
							...
							<td><a class="text-decoration-none" href="update-package.php?pid=<?php echo htmlentities($result->pid);?>"><?php echo htmlentities($result->pckname);?></a></td>
