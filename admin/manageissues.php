...
<html>
<head>
<title>EXMATE | Admin Manage Issues</title>
...
<div class="agile-grids">	
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2 class="text-center"><strong>Manage Issues</strong></h2>
					    <table id="table">
						<thead>
						  <tr>
						  <th>#</th>
...
<td><a class="text-decoration-none" href="javascript:void(0);" onClick="popUpWindow('updateissue.php?iid=<?php echo ($result->id);?>');">View </a>
</td>
