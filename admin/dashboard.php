...
<html>
<head>
<title>EXMATE | Admin Dashboard</title>
...
<!--four-grids here-->
		<div class="four-grids">
					<div class="col-md-3 four-grid">
						<div class="four-agileits bg-danger">
							<div class="icon">
								<i class="glyphicon glyphicon-user" aria-hidden="true"></i>
							</div>
							<div class="four-text">
								<h3><strong>Toatal Users</strong></h3>
...
$cnt=$query->rowCount();
					...
					<div class="col-md-2 four-grid">
						<div class="four-agileinfo bg-warning">
							<div class="icon">
								<i class="glyphicon glyphicon-list-alt" aria-hidden="true"></i>
							</div>
							<div class="four-text">
								<h3><strong>Toatal Bookings</strong></h3>
...
$cnt1=$query1->rowCount();
					...
					<div class="col-md-2 four-grid">
						<div class="four-w3ls bg-success">
							...
							<div class="four-text">
								<h3><strong>Toatal Enquiries</strong></h3>
...
$cnt2=$query2->rowCount();
					...
					<div class="col-md-2 four-grid">
						<div class="four-wthree bg-secondary">
							<div class="icon">
								<i class="glyphicon glyphicon-briefcase" aria-hidden="true"></i>
							</div>
							<div class="four-text">
								<h3><strong>Toatal packages</strong></h3>
...
$cnt3=$query3->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-w3ls">
							...
							<div class="four-text">
								<h3><strong>Issues Riaised</strong></h3>
